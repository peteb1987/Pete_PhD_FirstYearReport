...
\subfigure[Observations]{\includegraphics[width=0.45\columnwidth]{DetectionTrackingObs.pdf}}
\subfigure[States and Particle Estimates]{\includegraphics[width=0.45\columnwidth]{DetectionTracking.pdf}}
