...
\subfigure[PDAF]{\includegraphics[width=0.49\columnwidth]{results_PDAF-crop.pdf}}
...
\begin{figure} \centering
\subfigure[SISR(1)]{\includegraphics[width=0.49\columnwidth]{results_SISR1-crop.pdf}}
\subfigure[SISR(5)]{\includegraphics[width=0.49\columnwidth]{results_SISR5-crop.pdf}} \\
\subfigure[RB-SISR(5)]{\includegraphics[width=0.49\columnwidth]{results_RB-SISR5-crop.pdf}}
\caption{SISR tracking results. All particles plotted.}%
\label{fig:Tracking_SISR}%
\end{figure}

\begin{figure} \centering
\subfigure[MCMC(1)]{\includegraphics[width=0.49\columnwidth]{results_MCMC1-crop.pdf}}
\subfigure[MCMC(5)]{\includegraphics[width=0.49\columnwidth]{results_MCMC5-crop.pdf}} \\
\subfigure[RB-MCMC(5)]{\includegraphics[width=0.49\columnwidth]{results_RB-MCMC5-crop.pdf}}
