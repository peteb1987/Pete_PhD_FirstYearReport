...
\begin{figure}%
\subfigure[state]{\includegraphics[width=0.3\columnwidth]{results_wide_low_state-crop.pdf}}
\subfigure[linear observations]{\includegraphics[width=0.3\columnwidth]{results_wide_low_lGobs-crop.pdf}}
\subfigure[bearing-range observations]{\includegraphics[width=0.3\columnwidth]{results_wide_low_brobs-crop.pdf}}
\caption{Case 1}%
\label{fig:EgScen1}%
\end{figure}
\begin{figure}%
\subfigure[state]{\includegraphics[width=0.3\columnwidth]{results_wide_high_state-crop.pdf}}
\subfigure[linear observations]{\includegraphics[width=0.3\columnwidth]{results_wide_high_lGobs-crop.pdf}}
\subfigure[bearing-range observations]{\includegraphics[width=0.3\columnwidth]{results_wide_high_brobs-crop.pdf}}
\caption{Case 2}%
\label{fig:EgScen2}%
\end{figure}
\begin{figure}%
\subfigure[state]{\includegraphics[width=0.3\columnwidth]{results_wide_noise_state-crop.pdf}}
\subfigure[linear observations]{\includegraphics[width=0.3\columnwidth]{results_wide_noise_lGobs-crop.pdf}}
\subfigure[bearing-range observations]{\includegraphics[width=0.3\columnwidth]{results_wide_noise_brobs-crop.pdf}}
\caption{Case 3}%
\label{fig:EgScen3}%
\end{figure}
\begin{figure}%
\subfigure[state]{\includegraphics[width=0.3\columnwidth]{results_close_state-crop.pdf}}
\subfigure[linear observations]{\includegraphics[width=0.3\columnwidth]{results_close_lGobs-crop.pdf}}
\subfigure[bearing-range observations]{\includegraphics[width=0.3\columnwidth]{results_close_brobs-crop.pdf}}
\caption{Case 4}%
\label{fig:EgScen4}%
\end{figure}
